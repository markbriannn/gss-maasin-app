            ...
            <View style={{ padding: 20, borderTopWidth: 1, borderTopColor: '#E5E7EB' }}>
              {!hasScrolledToBottom && (
                <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 12, paddingHorizontal: 4 }}>
                  <Icon name="arrow-down-circle-outline" size={16} color="#F59E0B" />
                  <Text style={{ fontSize: 12, color: '#F59E0B', marginLeft: 6, fontWeight: '500' }}>
                    Please scroll down to read all terms before agreeing
                  </Text>
                </View>
              )}
              <TouchableOpacity
                style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16, opacity: hasScrolledToBottom ? 1 : 0.4 }}
                onPress={() => hasScrolledToBottom && setAcceptedTerms(!acceptedTerms)}
                ...
                <Text style={{ flex: 1, fontSize: 14, color: hasScrolledToBottom ? '#4B5563' : '#9CA3AF' }}>
