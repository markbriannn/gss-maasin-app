      ...
      const jobsList = await Promise.all(
        snapshot.docs.map(async (docSnap) => {
          ...
          return {
            ...
            scheduledDate: data.scheduledDate?.toDate?.() ? data.scheduledDate.toDate().toLocaleDateString() : (data.scheduledDate || data.date || 'TBD'),
            scheduledTime: data.scheduledTime?.toDate?.() ? data.scheduledTime.toDate().toLocaleTimeString() : (data.scheduledTime || data.time || 'TBD'),
