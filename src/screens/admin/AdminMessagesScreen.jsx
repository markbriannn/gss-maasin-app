      ...
      <TouchableOpacity
        ...
        <View style={{
          ...
          <View style={{
            ...
            borderWidth: 1, borderColor: getRoleBadgeColor(conversation.otherUser?.role),
          }}>
            <Text style={{fontSize: 8, fontWeight: '700', color: getRoleBadgeColor(conversation.otherUser?.role)}}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
            ...
            {conversation.unreadCount > 0 && (
              <View style={{
                ...
                backgroundColor: '#00B14F', justifyContent: 'center',
                alignItems: 'center', marginLeft: 8, paddingHorizontal: 6,
              }}>
    ...
    <SafeAreaView style={[globalStyles.container, isDark && {backgroundColor: theme.colors.background}]} edges={['top']}>
      ...
      {displayedConversations.length > 0 ? (
        ...
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 80}}>
          ...
          {!showArchived && (
            <TouchableOpacity
              style={{marginTop: 20, backgroundColor: '#00B14F', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 8}}
              onPress={() => navigation.navigate('Jobs')}>
              <Text style={{color: '#FFFFFF', fontWeight: '600'}}>View Jobs to Message Users</Text>
            </TouchableOpacity>
          )}
        </View>
      )}
