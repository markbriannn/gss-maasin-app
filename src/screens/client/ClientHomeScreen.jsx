...
const ProviderCard = memo(({ provider, isSelected, onPress }) => {
  return (
    <TouchableOpacity
      ...
      <View style={[styles.cardRow, isSelected && { paddingLeft: 16 }]}>
        {/* Avatar */}
        ...
        <View style={styles.info}>
          ...
          {provider.completedJobs > 50 && (
            <View style={styles.jobsBadge}>
              ...
              <Text style={styles.jobsBadgeText}>Verified Pro</Text>
            </View>
          )}
          {provider.completedJobs > 20 && provider.completedJobs <= 50 && (
            <View style={styles.jobsBadge}>
...
const styles = StyleSheet.create({
  ...
  liveBannerInline: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(0,177,79,0.95)', paddingHorizontal: 16, paddingVertical: 12, borderRadius: 28, shadowColor: '#00B14F', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 6 },
  liveDot: { width: 8, height: 8, backgroundColor: '#FFF', borderRadius: 4, marginRight: 8 },
  liveText: { fontSize: 12, fontWeight: '600', color: '#FFF' },
  liveSep: { marginHorizontal: 6, color: 'rgba(255,255,255,0.7)' },

  // Categories
  catScroll: { position: 'absolute', top: 60, left: 0, right: 0 },
  catContent: { paddingHorizontal: 16, gap: 10 },
  catPill: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.92)', paddingHorizontal: 16, paddingVertical: 12, borderRadius: 24, elevation: 4, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 8, shadowOffset: { width: 0, height: 2 } },
  catText: { fontSize: 13, fontWeight: '700', color: '#374151', marginLeft: 8 },

  // Location Button
  locBtn: { position: 'absolute', right: 16, bottom: 80, width: 52, height: 52, backgroundColor: 'rgba(255,255,255,0.92)', borderRadius: 26, justifyContent: 'center', alignItems: 'center', elevation: 6, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 12, shadowOffset: { width: 0, height: 4 } },
  ...
  // Filters
  filterRow: { flexDirection: 'row', paddingHorizontal: 16, marginBottom: 12, gap: 10 },
  filterBtn: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 18, paddingVertical: 11, borderRadius: 28, backgroundColor: '#F3F4F6', gap: 6, borderWidth: 1, borderColor: '#E5E7EB' },
  filterActive: { backgroundColor: '#00B14F', borderColor: '#00B14F', shadowColor: '#00B14F', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.3, shadowRadius: 6, elevation: 4 },
  ...
  // Card
  card: { marginBottom: 10, borderRadius: 16, borderWidth: 1.5, borderColor: 'transparent', backgroundColor: '#FFF', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 3, overflow: 'hidden' },
  cardSelected: { borderColor: '#00B14F', backgroundColor: '#F0FDF4', shadowColor: '#00B14F', shadowOpacity: 0.15, elevation: 5 },
  cardAccent: { position: 'absolute', left: 0, top: 0, bottom: 0, width: 4, backgroundColor: '#00B14F', borderTopLeftRadius: 16, borderBottomLeftRadius: 16 },
  ...
  avatarPlaceholder: { width: 64, height: 64, borderRadius: 16, backgroundColor: '#F0FDF4', justifyContent: 'center', alignItems: 'center' },
  onlineDot: { position: 'absolute', bottom: -1, right: -1, width: 14, height: 14, borderRadius: 7, backgroundColor: '#00B14F', borderWidth: 2.5, borderColor: '#FFF' },
  ...
  modalAvatarPlaceholder: { width: 110, height: 110, borderRadius: 55, backgroundColor: '#F0FDF4', justifyContent: 'center', alignItems: 'center', borderWidth: 4, borderColor: '#00B14F' },
  onlineBadge: { position: 'absolute', bottom: 4, right: 4, width: 22, height: 22, borderRadius: 11, backgroundColor: '#00B14F', borderWidth: 3, borderColor: '#FFF' },
  viewProfileHint: { position: 'absolute', bottom: 0, right: 0, width: 30, height: 30, borderRadius: 15, backgroundColor: '#00B14F', justifyContent: 'center', alignItems: 'center', borderWidth: 2.5, borderColor: '#FFF' },
  ...
  modalInfoRow: { flexDirection: 'row', justifyContent: 'center', gap: 16, marginBottom: 16 },
  modalInfoItem: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#F9FAFB', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 14 },
  modalInfoText: { fontSize: 14, fontWeight: '600', color: '#374151' },
  modalPriceRow: { alignItems: 'center', marginBottom: 20, backgroundColor: '#F0FDF4', paddingHorizontal: 28, paddingVertical: 16, borderRadius: 20, width: '100%' },
  modalPriceLabel: { fontSize: 11, color: '#6B7280', marginBottom: 4, fontWeight: '500', textTransform: 'uppercase', letterSpacing: 1 },
  modalPrice: { fontSize: 32, fontWeight: '800', color: '#00B14F' },
  ...
  modalViewBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 16, borderRadius: 16, backgroundColor: '#F3F4F6', gap: 8 },
  modalViewText: { fontSize: 15, fontWeight: '700', color: '#374151' },
  modalBookBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 16, borderRadius: 16, backgroundColor: '#00B14F', gap: 8, shadowColor: '#00B14F', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.35, shadowRadius: 8, elevation: 6 },
