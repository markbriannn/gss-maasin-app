      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={{ padding: 16, backgroundColor: isDark ? theme.colors.background : '#FFFFFF' }}>
          ...
          <Text style={{ fontSize: 14, color: isDark ? theme.colors.textSecondary : '#4B5563', marginBottom: 24, lineHeight: 22 }}>
            Maasin City H.E.L.P App is dedicated to connecting the people of Maasin City with reliable and skilled service providers. We aim to make finding and booking local services as easy as a few taps on your phone.
          </Text>
          ...
          <View style={{ alignItems: 'center', paddingVertical: 16 }}>
            <Text style={{ fontSize: 12, color: isDark ? theme.colors.textSecondary : '#9CA3AF' }}>
              © 2024 Maasin City H.E.L.P App. All rights reserved.
            </Text>
          </View>
        </View>
      </ScrollView>
