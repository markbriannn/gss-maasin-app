...
export default function BookingsPage() {
  ...
  if (isLoading) {
    return (
      <ClientLayout>
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 flex items-center justify-center">
    ...
    <ClientLayout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900">
              ...
              {TABS.map((tab) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className={`text-3xl font-bold ${isActive ? 'text-gray-900 dark:text-white' : 'text-white'}`}>{count}</p>
                    <p className={`text-sm font-medium ${isActive ? 'text-gray-500 dark:text-gray-400' : 'text-white/80'}`}>{tab.label}</p>
                    {isActive && (
        ...
        <div className="max-w-6xl mx-auto px-4 -mt-6 relative z-10">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-black/20 p-2 flex items-center">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-gray-50 dark:bg-gray-700 rounded-xl focus:bg-white dark:focus:bg-gray-600 focus:ring-2 focus:ring-green-100 dark:focus:ring-green-900 focus:outline-none transition-all text-gray-700 dark:text-gray-200 dark:placeholder-gray-400"
              />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          {loadingData ? (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-16 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">No {activeTab.toLowerCase()} bookings</h3>
              <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-md mx-auto">Your {activeTab.toLowerCase()} service requests will appear here once you book a service</p>
              <button
              ...
              {bookings.map((job, index) => {
                ...
                return (
                  <div
                    ...
                    className="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg shadow-gray-100/50 dark:shadow-black/20 hover:shadow-xl hover:shadow-gray-200/50 dark:hover:shadow-black/30 transition-all duration-300 cursor-pointer overflow-hidden border border-gray-100 dark:border-gray-700 hover:border-[#00B14F]/30"
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      {/* Title */}
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 group-hover:text-[#00B14F] transition-colors">{job.title}</h3>
                      ...
                      <div className="flex items-center gap-5">
                        ...
                        <div className="text-right flex-shrink-0">
                          <p className="text-3xl font-bold text-gray-900 dark:text-white">₱{(job.totalAmount || job.amount).toLocaleString()}</p>
                      ...
                      {['traveling', 'arrived', 'in_progress'].includes(job.status) && job.provider?.phone && (
                        <div className="flex items-center gap-3 mt-5 pt-5 border-t border-gray-100 dark:border-gray-700">
                          <button
                            ...
                            className="flex-1 flex items-center justify-center gap-2 py-3 bg-gray-50 dark:bg-gray-700 rounded-xl text-gray-700 dark:text-gray-200 font-semibold hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                          >
